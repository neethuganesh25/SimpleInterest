  ...
  return (
    <>
      <div className='d-flex justify-content-center align-items-center' style={{width:'100%',height:'100vh'}}>
        ...
        <p style={{color:'blue'}}>Calculate your simple interest  </p>

        <div className=' flex-column rounded shadow bg-warning d-flex justify-content-center align-items-center p-3'>
        ...
        <form className='mt-4'>
          ...
          {!isPrinciple &&
            <p className='text-danger' style={{marginRight:'75%'}}>*Invalid Input</p>
            }
          ...
          <Button variant="contained" color="primary" style={{width:'190px',height:'60px'}} disabled={isPrinciple && isRate && isYear ?false:true} onClick={calculate}>CALCULATE</Button>
